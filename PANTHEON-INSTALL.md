...
| 0.3.1 | 2026-05-10 | **Patch.** Completeness audit fixes: add `.gitkeep` to `shared/assets/` (drop folder convention consistency); expand INSTALL.md Phase 5 post-install tree to show full repo layout. |
